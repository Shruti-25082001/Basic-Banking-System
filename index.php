...
<div class="main_div">
 ...
 <div class="container">
    <div class="row">
      ...
      <div class="col-sm-6">
        <img src="02.png" class="img-fluid" width="180" height="150" style="margin-top:40px;">
        <h1 class="main_text">SAMRIDDHI BANK</h1>
      ...
      <div class="col-sm-6">
        ...
        <img src="08.jpg" class="img-fluid" width="560" height="345" style="margin-top:40px;">
